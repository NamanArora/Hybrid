...
#ifdef CONFIG_USERSPACE_VOLTAGE_CONTROL /* voltage table for voltage control */

static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p1[] = {
	{ 1,  96000,  PLL0,    4, 2,   1050000,  1050000, 2 },
	{ 1,  192000, ACPUPLL, 5, 2,   1050000,  1050000, 3 },
	{ 1,  259000, ACPUPLL, 4, 2,   1050000,  1050000, 4 },
	{ 1,  300000, PLL0,    4, 2,   1050000,  1050000, 4 },
	{ 1,  384000, ACPUPLL, 5, 2,   1050000,  1050000, 4 },
	{ 1,  499000, ACPUPLL, 5, 2,   1050000,  1050000, 4 },
	{ 1,  600000, PLL0,    4, 0,   1150000,  1050000, 6 },
	{ 1,  787200, ACPUPLL, 5, 0,   1150000,  1050000, 6 },
	{ 1,  998400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1190400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p4[] = {
	...
	{ 1, 1094400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1190400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1305600, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1344000, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1401600, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p6[] = {
	...
	{ 1,  600000, PLL0,    4, 0,   1150000,  1050000, 6 },
	{ 1,  787200, ACPUPLL, 5, 0,   1150000,  1050000, 6 },
	{ 1,  998400, ACPUPLL, 5, 0,   1150000,  1100000, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1190400, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1305600, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1344000, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1401600, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1497600, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 1, 1593600, ACPUPLL, 5, 0,   1275000,  1100000, 7 },
	{ 0 }
};

static struct clkctl_acpu_speed acpu_freq_tbl_8610[] = {
	{ 1,  300000, PLL0,    4, 2,   1050000,  1050000, 3 },
	{ 1,  384000, ACPUPLL, 5, 2,   1050000,  1050000, 3 },
	{ 1,  600000, PLL0,    4, 0,   1150000,  1050000, 4 },
	{ 1,  787200, ACPUPLL, 5, 0,   1150000,  1050000, 4 },
	{ 1,  998400, ACPUPLL, 5, 0,   1275000,  1100000, 5 },
	{ 1, 1190400, ACPUPLL, 5, 0,   1275000,  1100000, 5 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p1[] = {
	...
	{ 1,  499000, ACPUPLL, 5, 2,   CPR_CORNER_2,    0, 4 },
